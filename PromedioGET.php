...
<div id="caja">
    <form action="" method="get">
        <label for="num1">Nota Examen 1 (25%):</label>
        <input type="number" name="txtn1"><br>
        <label for="num1">Nota Examen 2 (25%):</label>
        <input type="number" name="txtn2"><br>
        <label for="num1">Nota Examen 3 (50%):</label>
    ...
    if(isset($_GET['sumatotal'])) {
        ...
        $t = ($n1 * 0.25) + ($n2 * 0.25) + ($n3 * 0.50);


        echo "el promedio del alumno es de " . $t . "";
    }
    ?>
