...
<div id="caja">
    <form method="post" action="">
        <label for="inversionsocio1">Inversión Socio 1:</label>
        <input type="number" id="inversionsocio1" name="inversionsocio1"><br>
        <label for="inversionsocio2">Inversión Socio 2:</label>
        <input type="number" id="inversion2" name="inversionsocio2"><br>
        <label for="inversionsocio3">Inversión Socio 3:</label>
        <input type="number" id="inversionsocio3" name="inversionsocio3"><br>
        <button type="submit">Enviar</button>
    </form>

    <?php
    if (isset($_POST['inversionsocio1']) && isset($_POST['inversionsocio2']) && isset($_POST['inversionsocio3'])) {
        $inversionsocio1 = (int)$_POST['inversionsocio1'];
        $inversionsocio2 = (int)$_POST['inversionsocio2'];
        $inversionsocio3 = (int)$_POST['inversionsocio3'];
        
        $total = $inversionsocio1 + $inversionsocio2 + $inversionsocio3;
        
        $porcentaje1 = ($inversionsocio1 / $total) * 100;
        $porcentaje2 = ($inversionsocio2 / $total) * 100;
        $porcentaje3 = ($inversionsocio3 / $total) * 100;

        echo "<p>El Socio 1 tiene un porcentaje de inversión de $porcentaje1%.</p>";
        echo "<p>El Socio 2 tiene un porcentaje de inversión de $porcentaje2%.</p>";
        echo "<p>El Socio 3 tiene un porcentaje de inversión de $porcentaje3%.</p>";
    }
    ?>
