...
<div id="caja">
    <form method="post">
        <label for="salario">Ingrese salario:</label>
    ...
    if (isset($_POST['salario'])) {
        ...
        $salarioempleado = $salario * 0.04;
        $salarioempleador = $salario * 0.08;
        echo "<p>El empleado paga $salarioempleado en salud y el empleador paga $salarioempleador en salud.</p>";
    }
    ?>
