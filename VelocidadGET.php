...
<div id="caja">
    <form action="" method="get">
        <label for="num1">Distancia final:</label>
        <input type="number" name="txtn1"><br>
        <label for="num1">Distancia inicial:</label>
        <input type="number" name="txtn2"><br>
        <label for="num1">Tiempo final:</label>
        <input type="number" name="txtn3"><br>
        <label for="num1">Tiempo inicial:</label>
        <input type="number" name="txtn4"><br>
    ...
    if(isset($_GET['sumatotal'])) {
        ...
        echo "La velocidad del objeto es de: " . $t . "";
    }
    ?>
