...
if (isset($_POST["calcular"])) {
    ...
    foreach ($notas as $nota) {
        if ($nota >= 30) {
            ...
            $contador_desaprobadas=$contador_desaprobadas + 1;
        }
    }

    if ($contador_aprobadas > 0) {
        $promedio_aprobadas = $suma_aprobadas / $contador_aprobadas;
        echo "El promedio de las notas aprobadas es: " . $promedio_aprobadas . "<br>";
    } else {
        echo "No hay notas aprobadas.<br>";
    }

    if ($contador_desaprobadas > 0) {
        $promedio_desaprobadas = $suma_desaprobadas / $contador_desaprobadas;
        echo "El promedio de las notas desaprobadas es: " . $promedio_desaprobadas . "<br>";
    } else {
        echo "No hay notas desaprobadas.<br>";
    }
}
?>
</div>
