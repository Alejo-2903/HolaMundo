...
<div id="caja">
    <form method="post">
        ...
        <label for="descuentoP">Descuento porcentaje:</label>
        <input type="number" id="descuentoP" name="descuentoP"><br>
        <button type="submit">Enviar</button>
    </form>

    <?php
    if (isset($_POST['precio']) && isset($_POST['descuentoP'])) {
        $precio = (int)$_POST['precio'];
        $descuentoP = (int)$_POST['descuentoP'];
        $iva = $precio * 0.19;
        $descuento = $precio * ($descuentoP / 100);
