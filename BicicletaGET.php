...
<div id="caja">
    <form action="" method="get">
        <label for="num1">Distancia (km):</label>
        <input type="number" name="txtn1"><br>
        <label for="num1">Velocidad (km/h):</label>
    ...
    if(isset($_GET['sumatotal'])) {
        ...
        echo "El tiempo que tarda en llegar es: " . $h . " horas, " . $m . " minutos y " . $s. " segundos.";
    }
    ?>
