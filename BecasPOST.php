...
<form method="POST">
    ...
    <label for="" >Ingrese el promedio:</label>
    <input type="text" name="promedio" > <br> <br>
    <input type="submit" value="Enviar" name="calcular"> <br> <br>
    </form>
        <?php
if (isset($_POST["calcular"])) {
    ...
    if ($edad > 18) {
        if ($promedio >= 90) {
            ...
            echo "Te invitamos a estudiar más en el próximo ciclo escolar.<br>";
    ...
    if (isset($beca)) {
        echo "El valor de la beca es: $" .$beca . "<br>";
    }
}
?>
</div>
