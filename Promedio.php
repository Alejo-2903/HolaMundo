...
<div id="caja">
    <form method="post" action="">
        ...
        <input type="number" id="calificacion3" name="calificacion3"><br>
        <label for="calificacion4">Calificación 4:</label>
        <input type="number" id="calificacion4" name="calificacion4"><br>
        <label for="calificacion5">Calificación 5:</label>
        <input type="number" id="calificacion5" name="calificacion5"><br>
        <button type="submit">Enviar</button>
    </form>

    <?php
    if (isset($_POST['calificacion1']) && isset($_POST['calificacion2']) && isset($_POST['calificacion3']) && isset($_POST['calificacion4']) && isset($_POST['calificacion5'])) {
        
            $calificacion1 = (int)$_POST['calificacion1'];
            $calificacion2 = (int)$_POST['calificacion2'];
            $calificacion3 = (int)$_POST['calificacion3'];
            $calificacion4 = (int)$_POST['calificacion4'];
            $calificacion5 = (int)$_POST['calificacion5'];
        
        $totalcal = $calificacion1 + $calificacion2 + $calificacion3 + $calificacion4 + $calificacion5;
        $promedio = $totalcal / 5;
