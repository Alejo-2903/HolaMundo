...
<form action="" method="post">
    ...
    <label for="txtnumero1">base:</label>
    <br> <input type="text" name="txtb" ><br>
    <label for="txnumero2">altura:</label>
    <br><input type="text" name="txth" ><br>
    <br><input type="submit" value="calcular" name="sumatotal"></br>
</form>
<?php
if (isset($_POST['sumatotal'])) {
    ...
    echo '<label for="result">Resultado:</label>';
    echo '<input type="text" id="result" value="' . $a .'"readonly>';
}
