...
<div id="caja">
    <form method="post">
        <label for="metros">Consumo en metros:</label>
    ...
    if (isset($_POST['metros'])) {
        ...
        $aguaenmetrocubico = $metros * 2500;
        $servicioaseo = 30000;
        $cargobasico = 11000;
        $total = $aguaenmetrocubico + $servicioaseo + $cargobasico;
        echo "<p>El valor total de la factura mensual es $total pesos.</p>";
    }
    ?>
